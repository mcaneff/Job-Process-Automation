...
def greenhouse(driver):
    try:
        ...
        #os.curdir()
        time.sleep(5)
        # driver.find_elements_by_id("resume").send_keys(os.path.join(__location__,"Michael Caneff_Resume_V3.pdf"))
        # driver.find_elements_by_id("resume").send_keys("C:\Users\MCane\OneDrive\Documents\Personal Projects\Job Automation\Job-Process-Automation\Michael_Caneff_Resume_V3.pdf")
